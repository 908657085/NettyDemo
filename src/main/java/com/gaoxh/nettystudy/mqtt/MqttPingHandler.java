...
public class MqttPingHandler extends ChannelInboundHandlerAdapter {
    ...
    MqttPingHandler(MqttClientManager mqttClientManager,int keepAliveSeconds) {
    ...
    private void sendPingReq(final Channel channel) {
        ...
        if (this.pingRespTimeout != null) {
            this.pingRespTimeout = channel.eventLoop().schedule(new Runnable() {
                @Override
                public void run() {
                ...
                //    clientManager.removeClosedChannel(channel);
                    System.out.println("ping timeout close connect ");
                }
